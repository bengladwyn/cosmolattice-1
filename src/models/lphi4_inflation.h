#ifndef LPHI4_INFLATION_H //Usual macro guard to prevent multiple inclusion
#define LPHI4_INFLATION_H
...
namespace TempLat
{
  ...
  #define MODELNAME lphi4_inflation
