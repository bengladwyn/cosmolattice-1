#ifndef MYTANH2_H //Usual macro guard to prevent multiple inclusion
#define MYTANH2_H
...
private:
	...
	double M, Lambda4, phii, omega, q, g, beta;
...
// fldS : The actual object which contains the scalar fields.
  ...
  public:
   ...
   /////////  
    ...
    auto potentialTerms(Tag<2>) // Secondary field potential energy
    {
        return 0.25 * beta * pow<4>(fldS(1_c));
    }
   ...
   ///////// 
    ...
    {
        return  q * fldS(1_c) * fldS(0_c) * fldS(0_c) + beta * pow<3>(fldS(1_c));
    }
   ...
   /////////
    ...
    {
        return  q * fldS(0_c) * fldS(0_c) + 3 * beta * pow<2>(fldS(1_c));
    }
